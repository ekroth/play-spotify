...
private[spotify] trait Objects {
  ...
  case class UserPublic(display_name: String, external_urls: ExternalURL, followers: Followers, href: String, id: String, images: Seq[Image], tipe: String, uri: String)
  ...
  case class AlbumSimplified(album_type: String, available_markets: Seq[String], external_urls: ExternalURL, href: String, id: String, images: Seq[Image], name: String, tipe: String, uri: String)
  ...
  case class TrackFull(album: AlbumSimplified, artists: Seq[ArtistSimplified], available_markets: Seq[String], disc_number: Int, duration_ms: Int, explicit: Boolean, external_ids: ExternalID, external_urls: ExternalURL, href: String, id: String, is_playable: Option[Boolean], linked_from: Option[TrackLink], name: String, popularity: Int, preview_url: Option[String], track_number: Int, tipe: String, uri: String)
  ...
  case class TrackSimplified(artists: Seq[ArtistSimplified], available_markets: Seq[String], disc_number: Int, duration_ms: Int, explicit: Boolean, external_urls: ExternalURL, href: String, id: String, is_playable: Option[Boolean], linked_from: Option[TrackLink], name: String, preview_url: String, track_number: Int, tipe: String, uri: String)
  ...
  case class AlbumFull(album_type: String, artists: Seq[ArtistSimplified], available_markets: Seq[String], copyrights: Seq[Copyright], external_ids: ExternalID, external_urls: ExternalURL, genres: Seq[String], href: String, id: String, images: Seq[Image], name: String, popularity: Int, release_date: String, release_date_precision: String, tracks: Paging[TrackSimplified], tipe: String, uri: String)
  ...
  case class ArtistFull(external_urls: ExternalURL, followers: Followers, genres: Seq[String], href: String, id: String, images: Seq[Image], name: String, popularity: Int, tipe: String, uri: String)
  ...
  case class PlaylistFull(collaborative: Boolean, description: Option[String], external_urls: ExternalURL, followers: Followers, href: String, id: String, images: Seq[Image], name: String, owner: UserPublicOther, public: Option[Boolean], snapshot_id: String, tracks: Paging[PlaylistTrack], tipe: String, uri: String)
  ...
  case class PlaylistSimplified(collaborative: Boolean, external_urls: ExternalURL, href: String, id: String, images: Seq[Image], name: String, owner: UserPublic, public: Option[Boolean], tracks: Tracks, tipe: String, uri: String)
  ...
  case class UserPrivate(birthdate: Option[String], country: Option[String], display_name: String, email: Option[String], external_urls: ExternalURL, followers: Followers, href: String, id: String, images: Seq[Image], product: Option[String], tipe: String, uri: String)
}
